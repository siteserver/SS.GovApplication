...
namespace SS.GovApplication.Core.Model
{
    ...
    {
        private const string AttributeValues = nameof(DataInfo.AttributeValues);
        ...
        public void Load(string json)
        {
            ...
            {
                var dict = Utils.Utils.JsonDeserialize<Dictionary<string, object>>(json);
                foreach (var key in dict.Keys)
                {
        ...
        public bool GetBool(string key, bool defaultValue = false)
        {
            ...
            return Utils.Utils.ToBool(value.ToString(), defaultValue);
        }
        ...
        public int GetInt(string key, int defaultValue = 0)
        {
            ...
            return Utils.Utils.ToIntWithNagetive(value.ToString(), defaultValue);
        }
        ...
        public decimal GetDecimal(string key, decimal defaultValue = 0)
        {
            ...
            return Utils.Utils.ToDecimalWithNagetive(value.ToString(), defaultValue);
        }
        ...
        public DateTime GetDateTime(string key, DateTime defaultValue)
        {
            ...
            return Utils.Utils.ToDateTime(value.ToString(), defaultValue);
        }
        ...
        public void Set(string name, object value)
        {
            ...
            {
                if (Utils.Utils.EqualsIgnoreCase(name, AttributeValues))
                {
                    Load(value.ToString());
                }
                else
        ...
        {
            return Utils.Utils.JsonSerialize(_dataDict);
        }
        ...
        public string ToString(List<string> excludeKeys)
        {
            ...
            {
                if (!Utils.Utils.ContainsIgnoreCase(excludeKeys, key))
                {
                    dict[key] = _dataDict[key];
                }
            }
            return Utils.Utils.JsonSerialize(dict);
        }
